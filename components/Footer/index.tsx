              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/"
                      className="mb-4 inline-block text-base font-medium text-body-color hover:text-primary pointer-events-none opacity-50 cursor-not-allowed"
                    >
                      {" "}
                      TOS{" "}
                    </a>
