...
const SingleGallery = ({ gallery }: { gallery: Gallery }) => {
  ...
  return (
    <>
      <div 
        className="wow fadeInUp relative overflow-hidden rounded-md bg-white shadow-one dark:bg-dark" data-wow-delay=".1s">
        ...
        <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-70 duration-300">
          <h1 className="title-font text-2xl font-medium text-gray-900 mb-3">{title}</h1>
          <a href="">{date}</a>
