...
const SingleGallery = ({ gallery }: { gallery: Gallery }) => {
  ...
  return (
    <>
      <div className="wow fadeInUp flex relative overflow-hidden rounded-md bg-white shadow-one dark:bg-dark" data-wow-delay=".1s">
        <Image src={image} alt="gallery1" fill style={{ objectFit: "cover" }}/>
