              ...
              <div>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="/images/blog/mukhlis-author.jpg"
                            alt="author"
                            fill
                          />
                        </div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Mau belajar bahasa pemrograman Python, tapi masih bingun mulainya dari mana?
                  </p>
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/blog-detail-01.png"
                        alt="image"
                        fill
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    Python banyak digunakan untuk membuat berbagai macam program, seperti: program CLI, program GUI  (desktop), aplikasi mobile, web IoT, game, program untuk hacking, dan bahkan yang sekarang sedang ramai adalah python digunakan untuk membuat sistem artificial intelligence.
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                  ...
                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/meme-python.png"
                        alt="image"
                        width={800}
                        height={500}
                        // fill
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Jadi, tunggu apalagi mulailah belajar bahasa pemrograman python biar ga penasaran. Kalian bisa mulai dengan otodidak atau jika mampu untuk membeli bootcamp yang tersedia beberapa platform belajar online.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Referensi :
                    <span>
